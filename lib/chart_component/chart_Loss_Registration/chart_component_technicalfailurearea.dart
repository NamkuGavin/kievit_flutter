...
class ChartComponent_TechnicalFailureArea extends StatefulWidget {
  List<Chart_model_SupplyFailureTechnicalFailureArea>
      dataChartSupplyFailureTechnicalFailureArea;

  ChartComponent_TechnicalFailureArea(
      {Key? key, required this.dataChartSupplyFailureTechnicalFailureArea})
      : super(key: key);

  @override
  _ChartComponent_TechnicalFailureAreaState createState() =>
      _ChartComponent_TechnicalFailureAreaState();
}

class _ChartComponent_TechnicalFailureAreaState
    extends State<ChartComponent_TechnicalFailureArea> {
                      ...
                      (i) => Row(
                        ...
                        children: [
                          ...
                          widget
                                  ...
                                  "0"
                              ? Text(
                                  '${widget.dataChartSupplyFailureTechnicalFailureArea[pointIndex].detail[i]['zone']} : ',
