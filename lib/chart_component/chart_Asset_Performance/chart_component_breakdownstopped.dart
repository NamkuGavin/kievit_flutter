...
class ChartComponent_BreakdownStopped extends StatefulWidget {
  List<Chart_model_PrimaryAndBreakdown_Stopped>
      dataChartPrimaryBreakdownStopped;

  ChartComponent_BreakdownStopped(
      {Key? key, required this.dataChartPrimaryBreakdownStopped})
      : super(key: key);

  @override
  _ChartComponent_BreakdownStoppedState createState() =>
      _ChartComponent_BreakdownStoppedState();
}

class _ChartComponent_BreakdownStoppedState
    extends State<ChartComponent_BreakdownStopped> {
    ...
    return Container(
      ...
      child: SfCartesianChart(
          ...
          series: <CartesianSeries>[
            ...
            StackedColumnSeries<Chart_model_PrimaryAndBreakdown_Stopped,
                    String>(
                name: widget.dataChartPrimaryBreakdownStopped[0].detail[3]
                    ['name'],
